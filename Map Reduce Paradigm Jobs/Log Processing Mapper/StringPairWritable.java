...
public class StringPairWritable implements WritableComparable<StringPairWritable> {
  ...
  public void write(DataOutput out) throws IOException {
    ...
    /*
     * Writes UTF to data outputs for left & right
     */
	  out.writeUTF(left);
	  out.writeUTF(right);
  ...
  public void readFields(DataInput in) throws IOException {
    ...
    /*
     * Scans to read field on data inputs assigning to left & right
     */
    left = in.readUTF();
    right = in.readUTF();
  }
  ...
  public int compareTo(StringPairWritable other) {
    /* Value compared to another in string to see if one is equal, return
     */
	int val = 0;
	val = left.compareTo(other.left);
	
	if (val == 0) { return right.compareTo(other.right); }
